...
while True:
	try:
		...
		save_to_file("front_camera_predictions.txt", str(datetime.datetime.now()))
		...
		for (i, pred) in enumerate(predictions):
			...
			if pred_conf > args["confidence"]:
				...
				pred_info = "[INFO] Prediction #{}: class={}, confidence={}, boxpoints={}".format(i, CLASSES[pred_class], pred_conf, pred_boxpts)
				print(pred_info)
				save_to_file("front_camera_predictions.txt", pred_info)
